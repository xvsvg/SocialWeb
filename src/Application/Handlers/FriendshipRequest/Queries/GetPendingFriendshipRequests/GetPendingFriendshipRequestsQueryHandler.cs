...
public sealed class GetPendingFriendshipRequestsQueryHandler 
    : IQueryHandler<GetPendingFriendshipRequestsQuery, PagedResponse<FriendshipRequestResponse>>
{
    private readonly PaginationConfiguration _configuration;
    private readonly IDatabaseContext _context;

    public GetPendingFriendshipRequestsQueryHandler(
        ...
        CancellationToken cancellationToken)
    {
        var friendshipRequestResponsesQuery =
            ...
            where friendshipRequest.FriendId == request.UserId
